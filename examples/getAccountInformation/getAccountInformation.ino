...
void loop()
{
  String accountInformation = myAlgoduino.getAccountInformation("YKYAFMDGGYCUIAGSBOSEZYJAZG6WRHHTZI3CMBEDLW7SKKRRTGGQAGYCHA");

  Serial.println("accountInformation: ");
  Serial.println("");
  Serial.println(accountInformation);
  Serial.println("");
